...
from .poni_agent_module import PONIAgentModule

# For visualizing exploration issues
debug_frontier_map = False


class PONIAgent(Agent):
    ...
    def __init__(self, config, device_id: int = 0):
        ...
        self._module = PONIAgentModule(config, device_id)
        ...
        self.planner = SafeDiscretePlanner(
            ...
            safe_obs_dilation_selem_radius=config.AGENT.PLANNER.obs_dilation_selem_radius
            + 3,
