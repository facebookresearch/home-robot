...
class SimpleSkillMotionPlanner(object):
    """Simple skill motion planner to connect three-six waypoints into a continuous motion"""

    def __init__(self, robot: HelloStretchKinematics, skill_standoffs: Dict):
        """
        Solve IK
        """
    ...
    def plan_for_skill(
        self, skill_actions: Tuple[np.ndarray], initial_cfg: np.ndarray
