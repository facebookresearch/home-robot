...
class MaskRCNNServer(object):
    def __init__(self, device=None):
        ...
        self.model = maskrcnn_resnet50_fpn(pretrained=True, progress=True, num_classes=len(COCO_CATEGORIES)).to(self.device)
        self.model.eval()
    ...
    def spin(self, rate=60):
        ...
        while not rospy.is_shutdown():
            ...
            print(res.keys())
            print([(COCO_CATEGORIES[int(l)], s) for (s, l) in zip(res['scores'], res['labels'])])
