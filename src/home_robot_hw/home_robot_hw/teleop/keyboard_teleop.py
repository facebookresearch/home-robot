...
class RobotBaseController:
    def __init__(self, hz=HZ_DEFAULT):
        ...
        # Keyboard
        self.key_states = {}
        self.trigger_keys = {key: 0 for key in [
            kb.KeyCode.from_char('1'),
            kb.KeyCode.from_char('2'),
            kb.KeyCode.from_char('3'),
            ]}
    ...
    def run(self):
        print(
            ...
            "\n"
            "== Camera commands ==\n"
            "1:\t Look forwards horizontally\n"
            "2:\t Look forwards at a 45-degree down angle\n"
            "3:\t Look at gripper (approximately)\n"
            "-------------------------------------\n"
        )
        ...
        while self.alive:
            ...
            if self.mode == ControlMode.NAV:
                ...
                rvel = self._compute_net_command(kb.Key.left, kb.Key.right, BASE_RVEL_MAX)
