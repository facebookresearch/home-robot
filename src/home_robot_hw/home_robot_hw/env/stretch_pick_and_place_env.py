...
from home_robot.motion.stretch import STRETCH_HOME_Q, STRETCH_PREGRASP_Q, STRETCH_ARM_EXTENSION, STRETCH_ARM_LIFT
    ...
    def apply_action(self, action: Action, info: Optional[Dict[str, Any]] = None):
        ...
        if action.is_discrete():
            ...
            if action == DiscreteNavigationAction.MOVE_FORWARD:
                ...
                print("EXTENDING ARM")
                joints_action = self.robot.model.create_action(lift=STRETCH_ARM_LIFT, arm=STRETCH_ARM_EXTENSION).joints
                continuous_action = None
