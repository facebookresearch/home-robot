...
def main(spot=None, args=None):
    ...
    while not env.episode_over:
        ...
        #@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        #see if goal xyt gets saved here, add grasp controller here
        #goals need to be a list, not a series of string
        grasp = GraspController(config=config, spot=spot, objects=goals, show_img=False, top_grasp=True)
        time.sleep(1)
        spot.open_gripper()
        time.sleep(1)
        print(" > Maybe grasping")
        image_responses = spot.get_image_responses([SpotCamIds.HAND_COLOR])
        grasp.grasp(image_responses=image_responses)
        #@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
