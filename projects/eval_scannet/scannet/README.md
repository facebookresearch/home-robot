...
> From https://github.com/open-mmlab/mmdetection3d/blob/1.0/data/scannet/README.md

We follow the procedure of [MMDet](https://mmdetection3d.readthedocs.io/en/v0.15.0/datasets/scannet_det.html), adapted from [votenet](https://github.com/facebookresearch/votenet/).

### Quickstart
The overall process could be achieved through the following script

```bash
python batch_load_scannet_data.py --max_num_point 50000 --train_scannet_dir /datasets01/scannet/082518/scans --test_scannet_dir /datasets01/scannet/082518/scans_test
python extract_posed_images.py  --max-images-per-scene -1
cd ../..
