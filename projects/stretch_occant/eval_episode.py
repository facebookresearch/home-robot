...
from home_robot.agent.occant_agent.occant_agent import OccAntAgent
...
def main(agent, dry_run):
    config_path = "projects/stretch_occant/configs/agent/occant_rgbd_eval.yaml"
    ...
    if agent == "discrete":
        agent = OccAntAgent(config=config)
    else:
